...
- *Firefox* &mdash;
Наиболее массовый не WebKit браузер на сегодняшний день.
- *Google Chrome* / *Chromium* &mdash;
Один из самых быстрых и популярных браузеров.
- *Splash* &mdash; легкий браузер с поддержкой javascript реализовыннй на
python-е предоставляюший для управления http api.
- *Ghost.py* &mdash; python браузер с поддержкой javascript ориентированный на
автоматическое функциональное тестирование.
- *Zombie.js* &mdash; легкий и быстрый безголовый браузер для автоматического
тестирования основаный на node.js
- *Phantom.js* &mdash; быстрый безголовый браузер на движке WebKit со
встроенной поддержкой svg. Управляется при помощи javascript api.
- *Slimer.js* &mdash; быстрый браузер, похожий на phantomjs, однако использует
движек Gecko от firefox. Управляется при помощи javascript api.
...
настоящий момент &mdash; эталоном качества будут выступать снимки `firefox`-а.
...
`Ghost.py` &mdash; оказался чрезвычайно прожорливым, занимая всю доступную
